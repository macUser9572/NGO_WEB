                    ...
                    child: StreamBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (isYoutubeUrl(videoUrl)) {
                          // YouTube → show thumbnail with play button in box
                        ...
                        // Firebase Storage → plays directly in box
...
// ===================== YOUTUBE IN-BOX PLAYER =====================
// Shows thumbnail → click play → video plays inside the box via iframe
...
class _YoutubeInBoxPlayerState extends State<_YoutubeInBoxPlayer> {
  ...
  void initState() {
    ...
    // Register YouTube iframe with autoplay=1 so it starts when shown
...
// Plays .mp4 files uploaded directly to Firebase Storage
