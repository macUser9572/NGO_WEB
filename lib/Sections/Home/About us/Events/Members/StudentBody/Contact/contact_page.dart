...
class _DesktopLayoutState extends State<_DesktopLayout> {
  ...
  // ✅ CORRECT IDs
  static const String _serviceId  = 'service_2ugbc7f'; // ← FIXED
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Got anything for us ?",
                        style: GoogleFonts.inter(fontSize: 24,
                            fontWeight: FontWeight.w700,
                            color: AllColors.primaryColor)),
                      const SizedBox(height: 6),
                      Text("Drop your message and we get back to you.",
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Reach Us",
                        style: GoogleFonts.inter(fontSize: 80,
                            fontWeight: FontWeight.w800,
                            color: AllColors.primaryColor)),
                      ...
                      _infoRow(Icons.email_outlined,
                          "admin@bangalorechakmasociety.org"),
...
//           // ── Contact Info ──
//           _infoRow(Icons.email_outlined, "admin@bangalorechakmasociety.org"),
//           const SizedBox(height: 12),
//           _infoRow(Icons.phone_outlined, "+91 6366009470"),
